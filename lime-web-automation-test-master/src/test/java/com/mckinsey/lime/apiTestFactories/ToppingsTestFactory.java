...
import com.mckinsey.lime.apiTests.ToppingsTest;
import com.mckinsey.lime.mobileTestFactories.DataProviders;
import com.mckinsey.lime.testDataBeans.UsersDataBean;
import org.testng.annotations.Factory;

@Deprecated
public class ToppingsTestFactory {

    @Factory(dataProvider = "dp", dataProviderClass = DataProviders.class)
    public Object[] toppingsTestInstances(UsersDataBean.User indUser) {
        return new Object[]{new ToppingsTest(indUser)};
    }
}
